...
export const metadata: Metadata = {
  title: 'grade-sync | attendances',
  description: 'This is a school management webapp',
};

const ListPageOfAttendances = async (props: { searchParams: SearchParams }) => {
  ...
  return (
    <div className="m-2 flex flex-1 flex-col gap-2 rounded-md bg-white px-4 py-2">
      <div className="flex items-center justify-between">
        <p className="hidden text-lg font-semibold md:block">All Attendances</p>
        <div className="flex w-full flex-col gap-2 md:w-auto md:flex-row md:items-center">
          ...
          <div className="flex items-center justify-end gap-2 md:justify-normal">
            ...
            {(role === 'admin' || role === 'teacher') && (
              <CreateModal table="attendance" lessons={lessons} />
            )}
          </div>
        </div>
      </div>
      ...
      <div>
        <AttendanceTable data={attendances} role={role} lessons={lessons} />
      </div>
...
export default ListPageOfAttendances;
